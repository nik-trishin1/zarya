...
Vendored from [mattpocock/skills](https://github.com/mattpocock/skills) `productivity/writing-for-agents` (MIT). In this repo, prefer progressive disclosure into `.cursor/skills/` and pointers from `AGENTS.md`; keep AI-Factory and NMT contracts as single sources of truth (`process/ai-factory/`, `process/next-move-theory/`).
