...
def test_build_event_startapp_link():
    assert build_event_startapp_link("zarya_bot", 42) == "https://t.me/zarya_bot?startapp=event_42"


def test_build_new_event_announcement_puts_name_before_link():
    message = build_new_event_announcement(_event(), "zarya_bot")
    ...
    link = "https://t.me/zarya_bot?startapp=event_42"
...
def test_build_new_event_announcement_omits_empty_description():
    event = _event()
    event.description = "   "
    message = build_new_event_announcement(event, "zarya_bot")
